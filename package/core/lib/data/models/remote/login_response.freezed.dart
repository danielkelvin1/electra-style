...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "access_token") String accessToken, UserModel data});
...
class _$LoginResponseImpl implements _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(accessToken: $accessToken, data: $data)';
  }
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final UserModel data}) = _$LoginResponseImpl;
