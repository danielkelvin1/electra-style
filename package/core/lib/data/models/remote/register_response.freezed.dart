...
class _$RegisterResponseImpl implements _RegisterResponse {
  ...
  @override
  String toString() {
    return 'RegisterResponse(message: $message, accessToken: $accessToken, data: $data)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, message, accessToken, data);
...
abstract class _RegisterResponse implements RegisterResponse {
  const factory _RegisterResponse(
      ...
      required final UserModel data}) = _$RegisterResponseImpl;
